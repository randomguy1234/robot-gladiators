var fightOrSkip= function()
{
    ...
    var promptFight= window.prompt('Would you like to FIGHT or SKIP' 
        +' this battle? Enter "FIGHT" or "SKIP" to choose.');
    ...
    for(var i= 0; i < enemyInfo.length; i++ )
    {
        ...
        if (playerInfo.health > 0)
        {
            ...
            if (playerInfo.health > 0 && i < enemyInfo.length -1)
            {
                ...
                var storeConfirm= window.confirm("The fight is over, visit "
                    +"the store before the next round?");
...
var endGame= function()
{
    ...
    if (playerInfo.money > highScore)
    {
        ...
        window.alert(playerInfo.name+" now has the high score of"
        +playerInfo.money+"!");
    }

    else
    {
        window.alert(playerInfo.name+" did not beat the high score of"
        +playerInfo.money+". Maybe next time");
    }
...
var shop= function()
{
    ...
    var shopOptionPrompt= window.prompt("Would you like to REFILL your health, "
        +"UPGRADE your attack, or LEAVE the store? Please enter one: 1 for REFILL, 2 for UPGRADE,"
        +" or 3 for LEAVE.");
